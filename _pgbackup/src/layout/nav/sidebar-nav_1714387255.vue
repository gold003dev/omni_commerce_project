        ...
        <simplebar class="h-100" id="leftside-menu-container">
            ...
            <ul class="side-nav">
                <li class="side-nav-item">
                    <router-link to="/dashboard" class="side-nav-link side-nav-link-ref"><i class="ri-dashboard-line"></i><span>Dashboard</span>
                    </router-link>
                </li>
                <!-- Ecommerce -->
                ...
                <li class="side-nav-item" role="button">
                    <a v-b-toggle.sidebarPorfolio class="side-nav-link" style="font-size: 16px; font-weight: 800;"> <i class="i-bytesize-portfolio"></i> <span>Portfolio</span> <span class="menu-arrow"></span> </a>
                    <b-collapse id="sidebarPorfolio">
                        <ul class="side-nav">
                            <li class="side-nav-item" v-for="option in availableMenuOptions">
                                <router-link :to="option.path" class="side-nav-link side-nav-link-ref" style="font-size: 16px;">
                ...
                <!-- Admin Zone -->
                <li class="side-nav-item" role="button">
                    <a v-b-toggle.sidebarAdmin class="side-nav-link"> <i class="uil-sliders-v-alt"></i> <span>Settings</span> <span class="menu-arrow"></span> </a>
