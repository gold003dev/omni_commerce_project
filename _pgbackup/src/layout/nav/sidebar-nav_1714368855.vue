...
<template>
  <div class="leftside-menu">
    <!-- Brand Logo Light -->
    <router-link to="/" class="logo logo-light"><span class="logo-lg"> <img src="@/assets/images/logo.png" alt="logo" />
      </span><span class="logo-sm"> <img src="@/assets/images/logo-sm.png" alt="small logo" /> </span>
    </router-link>
    <!-- Brand Logo Dark -->
    <router-link to="/" class="logo logo-dark"><span class="logo-lg"> <img src="@/assets/images/logo-dark.png"
          alt="dark logo" /> </span><span class="logo-sm"> <img src="@/assets/images/logo-sm.png" alt="small logo" />
      </span>
    </router-link>
    <!-- Menu Container -->
    <simplebar class="h-100" id="leftside-menu-container">
      ...
      <ul class="side-nav">
        ...
        <li class="side-nav-item" role="button"><a v-b-toggle.sidebarPorfolio class="side-nav-link"> <i
              class="uil-files-landscapes-alt"></i> <span>Portfolio</span> <span class="menu-arrow"></span> </a>
          <b-collapse id="sidebarPorfolio">
            <ul class="side-nav">
              <li class="side-nav-item" v-for="option in availableMenuOptions">
                <router-link :to="option.path" class="side-nav-link side-nav-link-ref"><i v-if="option.icon"
                    :class="option.iconClassList"></i><span>{{ option.name }}</span>
                </router-link>
              </li>
            </ul>
          </b-collapse>
        ...
        <!-- Admin Zone -->
        <li class="side-nav-item" role="button"><a v-b-toggle.sidebarAdmin class="side-nav-link"> <i
              class="uil-sliders-v-alt"></i> <span>Settings</span> <span class="menu-arrow"></span> </a>
