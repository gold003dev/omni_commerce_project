    ...
    <div class="leftside-menu">
        ...
        <simplebar class="h-100" id="leftside-menu-container">
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item" role="button"><a v-b-toggle.sidebarPorfolio class="side-nav-link" style="font-size: 16px; font-weight: 800;"> <i class="i-bytesize-portfolio"></i> <span>Portfolio</span> <span class="menu-arrow"></span> </a>
                    <b-collapse id="sidebarPorfolio">
                        <ul class="side-nav">
                            <li class="side-nav-item" v-for="option in availableMenuOptions">
                                <router-link :to="option.path" class="side-nav-link side-nav-link-ref" style="font-size: 16px;"><i v-if="option.icon" :class="option.iconClassList"></i><span>{{ option.name }}</span>
                                </router-link>
                            </li>
                        </ul>
                    </b-collapse>
